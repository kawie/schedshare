defmodule Schedshare.Accounts do
  @moduledoc """
  ...
  def get_user_by_session_token(token) do
    Logger.debug("Getting user by session token: #{inspect(token)}")
  ...
  ## Examples
      ...
      iex> update_user_admin(user, %{is_admin: true})
      {:ok, %User{}}

      iex> update_user_admin(user, %{is_admin: false})
      {:ok, %User{}}
