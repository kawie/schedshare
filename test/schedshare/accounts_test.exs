defmodule Schedshare.AccountsTest do
  ...
  describe "admin management" do
    ...
    test "update_user_admin/2 with valid data updates the user" do
    ...
    test "is_admin?/1 returns true for admin users" do
      ...
      {:ok, admin} = Accounts.update_user_admin(user, %{is_admin: true})
