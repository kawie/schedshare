...
# Configures api credential encryption key and schedule provider name (only required in production)
...
#
#     PHX_SERVER=true bin/schedshare start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :schedshare, SchedshareWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/schedshare/schedshare.db
      """
  ...
  host = System.get_env("PHX_HOST") || "schedshare.de"
